...
class TeleVision:
    def __init__(self, binocular, img_shape, img_shm_name, cert_file="legged_gym/legged_gym/teleop/cert.pem", key_file="legged_gym/legged_gym/teleop/key.pem", ngrok=False):
