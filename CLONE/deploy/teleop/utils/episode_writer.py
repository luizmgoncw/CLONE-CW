...
class EpisodeWriter(object):
    ...
    def add_item(self, colors, depths=None, states=None, actions=None, tactiles=None, audios=None, task_obs=None, log = False, \
        ...
        item_data = {
            ...
            'colors': {"color_0": None},
            'depths': {"depth_0": None},
            'states': {'left_arm':{}, 'right_arm':{}, 'left_hand':{}, 'right_hand':{}, 'waist': {}, 'left_leg':{}, 'right_leg':{}, 'imu':{}, 'head_servo':{}}, # dof_pos, dof_vel
            'actions': {'left_arm':{}, 'right_arm':{}, 'left_hand':{}, 'right_hand':{}, 'waist': {}, 'left_leg':{}, 'right_leg':{}, 'head_servo':{}},
            'tactiles': {'left_hand':[], 'right_hand':[]},
            'audios': { "mic0": None},
            'task_obs':{'head':[], 'left_hand':[], 'right_hand':[], 'left_ankle':[], 'right_ankle':[]},
